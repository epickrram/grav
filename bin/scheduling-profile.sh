...
sudo python "$SCRIPT_DIR/../src/cpu/bcc_scheduler_profile.py" "$PERF_RECORD_DURATION" "$PERF_DATA_DIR/scheduler-states-$PID.json" "$PERF_DATA_DIR/contending-commands-$PID.json"
